            ...
            <div class="row justify-content-center mb-3">
                <div class="col-md-8">
                    <div class="input-group mb-3">
                        <input id="input_search" class="form-control" name="key" placeholder="Nhập tên size ..."/>
...
<script>
    $(document).ready(function () {
                ...
                success: function (response) {
                    ...
                    $.each(response.data, function (index, size) {
                        sizeTable.row.add([
                            index + 1,
                            size.tenSize,
                            convertStatus(size.trangThai),
                            '<a href="/admin/size/detail/' + size.id + '" class="btn btn-info btn-sm"><i class="fa-solid fa-info"></i></a>' +
                            '<a href="/admin/size/update/' + size.id + '" class="btn btn-info btn-sm"><i class="fa-solid fa-pen"></i></a>'
                        ]);
                    });
                    sizeTable.draw();
                },
        ...
        $('#btn_search').click(loadTableSize);
        $('input[name="status_type"]').change(loadTableSize);
