...
<div class="container mt-4">
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-md-6">
                    <div class="input-group w-100">
                        <input id="input_search" class="form-control" name="key" placeholder="Tìm kiếm sản phẩm theo thương hiệu..." />
    ...
    <div class="card mt-4 custom-border"> <!-- Áp dụng custom-border cho card thương hiệu -->
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <h5 class="card-title">Danh sách thương hiệu</h5>
                <a href="/admin/brand/create" class="btn btn-teal"><i class="fa-solid fa-plus"></i> Thêm sản phẩm</a>
            </div>
